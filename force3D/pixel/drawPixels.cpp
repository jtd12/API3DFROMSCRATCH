...
void drawPixels::draw(std::vector<Triangle>& allTriangles,Uint32* framebuffer,float* framebufferDepth, int screenWidth, int screenHeight, const Camera& camera,const vector3d& carPosition,bool isPlayer,int min,int max,int min2)
{
	   int triIndex = 0;
...
float distance = (tri.v1 - carPosition).length();
...
void drawPixels::draw(std::vector<Triangle>& allTriangles,Uint32* framebuffer,float* framebufferDepth, int screenWidth, int screenHeight, const Camera& camera,const vector3d& carPosition,bool isPlayer)
{
	   int triIndex = 0;
